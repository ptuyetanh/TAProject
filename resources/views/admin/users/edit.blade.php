            ...
            <div class="row">
                <div class="col-sm-8 offset-sm-2">
                    <div class="card text-dark">
                        <div class="card-body">
                            <h4 class="card-title text-center mt-2 mb-4">Sửa người dùng</h4>
                            <form class="row g-3 needs-validation" method="post" action="{{url('admin/users/'.$user->id.'/update')}}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control"
                                               aria-describedby="inputGroupPrepend" name="birthday" id="birthday" value="{{old('birthday',$user->birthday)}}">
                                    </div>
